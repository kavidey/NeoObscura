...
int main(void) {
  ...
  // Begin smiley face 
  // Note: this overwrites all of the random pixels above, but keeping them in because that's a much larger picture so can be good for testing
  ...
  // At this point, ensure that pixels[] is an array of the 1200 pixels
  // If we are just using 3 channels (RGB), just set all Alpha values to 255 and QOI will handle it correctly
